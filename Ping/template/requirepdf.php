...
/*	$money[0]=getConsommationElec(19800723488459,"01/01/2016");
	...
	$pdf->Cell(180,20,"MA CONSO & MOI",0,2,'C'); 
	$pdf->SetFont('Arial','',16); 
	
	
	// Pour l'instant on affiche le mois actuel 
	$pdf->Cell(250,15,"Vos consommations du mois de ".strftime('%B'),0,2,'C');
	$pdf->SetFont('Arial','',16); 
	$nom = "Client";
	$frais = round($money[0]+$money[1]+$money[2],2);
	$identifiant= " Id Linky : ".$idLinky;
	$appele = "Cher $nom,";
	$content = "Le montant total de vos factures des energies du mois sont $frais euros.";
